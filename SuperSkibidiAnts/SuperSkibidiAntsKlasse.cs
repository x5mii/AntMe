...
namespace AntMe.Player.SuperSkibidiAnts
{
    /// <summary>
    ...
    /// </summary>
    [Spieler(
        Volkname = "SuperSkibidiAnts",   // Hier kannst du den Namen des Volkes festlegen
        Vorname = "Samuel",       // An dieser Stelle kannst du dich als Schöpfer der Ameise eintragen
        Nachname = "Lucena"       // An dieser Stelle kannst du dich als Schöpfer der Ameise eintragen
    )]
    ...
    public class SuperSkibidiAntsKlasse : Basisameise
    {
        #region Kasten
        ...
        {
            LasseNahrungFallen();
            if (AnzahlAmeisenInSichtweite >= 8)
            {
                GreifeAn(wanze);
            }
            else
